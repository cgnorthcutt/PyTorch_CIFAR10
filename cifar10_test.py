...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/datasets/datasets/cifar10')
    parser.add_argument('--pretrained_weights_dir', type=str, default='/datasets/datasets/cifar10/pretrained_models')
