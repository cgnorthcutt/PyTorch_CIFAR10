...
def googlenet(pretrained=False, progress=True, device='cpu', weights_dir=None, **kwargs):
    ...
    model = GoogLeNet()
    if pretrained:
        state_dict = torch.load(weights_dir + '/state_dicts/googlenet.pt', map_location=device)
