...
def inception_v3(pretrained=False, progress=True, device='cpu', weights_dir=None, **kwargs):
    ...
    model = Inception3()
    if pretrained:
        state_dict = torch.load(weights_dir + '/state_dicts/inception_v3.pt', map_location=device)
